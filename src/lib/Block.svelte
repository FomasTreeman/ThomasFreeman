<script lang="ts">
	...
	import HobbyCard from './HobbyCard.svelte';
	...
	const hobbies = [
		...
		{ icon: '🎮', title: 'Gaming', color: '#a78bfa' }
	];
</script>

<Divider flipped={false} />
<article>
	<h3>
	...
	<ul class="skills-list">
		...
		<li class="glass-pill">📊 Pandas + NumPy</li>
	</ul>

	<br />

	<h3>
		<span class="code-comment">//</span> Hobbies
	</h3>
